...
public class MainActivity extends SherlockListActivity implements OnClickListener , ActionBar.OnNavigationListener{
	...
	BlockListDB enterValues = new BlockListDB(this);
...
/** **************************************************** MENU *****************************************/
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		menuInflator.inflate(R.menu.prefsmenu, menu);
		return true;
	}
	...
	public boolean onMenuItemSelected(int featureId, MenuItem item) {
		...
		case R.id.whitelistact:
			Intent intentWhiteList = new Intent(MainActivity.this, WhiteListActivity.class);
...
/**************************** NAVIGATION *****************************************************/
	...
	/*	case 1:
		...
		case 1 :
			...
			//j.setClass(this, WhiteListActivity.class);
			startActivity(j);
			//return true;
			break;
